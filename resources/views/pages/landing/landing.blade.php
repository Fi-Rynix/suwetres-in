...
<div class="landing-hero">
    ...
    <p class="landing-description">
        Gabungan kata <span class="desc-span-1">Suwe</span> + <span class="desc-span-2">Stress</span>. Ukur kadar kelelahan akademikmu berdasarkan kurang tidur, tumpukan tugas, kepanitiaan toxic, dan kebanyakan scroll medsos menggunakan logika Fuzzy Sugeno Orde Nol yang cerdas!
    </p>
    ...
    <div class="landing-grid">
        <div class="neo-box landing-box landing-box-yellow">
            ...
            <h3 class="landing-box-title">4 Indikator Capek</h3>
            <p class="landing-box-text">Pantau jam tidur pas-pasan, deadline tugas menumpuk, rapat organisasi non-stop, dan durasi screen time seharian.</p>
        </div>
        ...
        <div class="neo-box landing-box landing-box-secondary">
            ...
            <h3 class="landing-box-title">Fuzzy Engine</h3>
            <p class="landing-box-text">Inferensi logika cerdas untuk menghitung seberapa mepet kamu ke arah burnout tanpa tebak-tebakan.</p>
        </div>
        ...
        <div class="neo-box landing-box landing-box-purple">
            ...
            <h3 class="landing-box-title text-white">Muka Kusut Scan</h3>
            <p class="landing-box-text text-white">Deteksi raut wajah kurang tidur dan mata panda secara instan via Webcam Browser API secara interaktif.</p>
        </div>
    </div>
</div>
@endsection
